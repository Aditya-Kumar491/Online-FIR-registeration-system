...
CREATE TABLE `images` (
 `id` int(11) NOT NULL AUTO_INCREMENT,`firid` int(11) NOT NULL,
...
(4, 'Mayank sharma', 'SI', 'Theft & Robbery', 'mayank@gmail.com', 'manku', 0),
(6, 'Anubhav Tyagi', 'SI', 'Domestic Affairs', 'tyagi@gmail.com', 'tyagi', 0),
(7, 'Abhishek Chaudhary', 'SI', 'Others', 'abhishekch699@gmail.com', 'abhi', 0),
